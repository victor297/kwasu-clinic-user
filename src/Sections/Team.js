              ...
              <div className="team-member">
                ...
                <div className="team-info">
                  <div className="team-info-comntent">
                    <h4 className="title">david victor</h4>
                    <span className="text-secondary">MERN</span>
                  </div>
                  <ul className="social-media">
                    <li>
                      <a href="https://github.com/victor297" target="_blank">
                        <BsGithub />
                      </a>
                    </li>
                    <li>
                      <a
                        href="https://www.linkedin.com/in/victor296/"
                        target="_blank"
                      >
                        <BsLinkedin />
                      </a>
                    ...
                    <li>
                      <a href="https://www.codefussion.com.ng" target="_blank">
                        <BsLink45Deg />
                      </a>
                    </li>
                  </ul>
