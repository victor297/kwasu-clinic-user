...
export const createBooking = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      `https://kwasu-hms-clinic-server.onrender.com/appointments/create`,
      data
    );
    console.log(res);
...
export const createPatient = (data) => async (dispatch) => {
  try {
    const res = await axios.post(
      `https://kwasu-hms-clinic-server.onrender.com/patients/register`,
      data
    );
    return res.data;
  } catch (error) {
...
//       `https://kwasu-hms-clinic-server.onrender.com/appointments`
//     );
